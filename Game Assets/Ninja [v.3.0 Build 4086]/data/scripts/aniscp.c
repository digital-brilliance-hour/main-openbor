...
void alterallstats(void aentity, int stage, int iDifficulty)
{
  ...
  if ( checkent(aentity) == 1
    ...
    iChance = rand()%100;
    if ( iChance > 98) {
      aentity = increaseaggressionforentity( aentity, 1+(iDifficulty/4) );
      sizeX = sizeX+30;
    ...
    iChance = rand()%100;
    if ( iChance > 98 ) {
      aentity = increasespeedforentity( aentity, 1+(iDifficulty/5) );
      sizeX = sizeX-40;
      sizeY = sizeY+20;
    }
    ...
    //Offense
    iChance = rand()%100;
    if ( (iChance + iDifficulty) > 98) {
      aentity = setalloffenseforentity(  aentity, (1+(iDifficulty/4)) );
      sizeX = sizeX+40;
      sizeY = sizeY+40;
     }
