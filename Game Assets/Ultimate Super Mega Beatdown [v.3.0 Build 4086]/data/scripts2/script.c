#include "data/scripts2/bscript.c"
#include "data/scripts2/item.c"
#include "data/scripts2/npc.c"
#include "data/scripts2/Chari.c"
...
{
	void self=getlocalvar("self");
	spawn01("lilc", 30, 40, 0) && spawn01("lilc", 0, 40, 0) && spawn01("lilc", 20, 40, 0) && spawn01("lilc", 15, 60, 0) && spawn01("lilc", -100, 40, 0) && spawn01("lilc", -150, 40, 0) && spawn01("lilc", -100, 60, 0) && spawn01("lilc", -50, 50, 0);
...
{
	void self=getlocalvar("self");
	spawn01("lild", 30, 40, 0) && spawn01("lild", 0, 40, 0) && spawn01("lild", 20, 40, 0) && spawn01("lild", 15, 60, 0) && spawn01("lild", -100, 40, 0) && spawn01("lild", -150, 40, 0) && spawn01("lild", -100, 60, 0) && spawn01("lild", -50, 50, 0);
...
void antiair() 
{
    ...
    void target = getentityproperty(self, "opponent");
      ...
      changeentityproperty(target, "velocity", 0, 0 , 0); // This is to stop entity from moving forward
      changeentityproperty(target, "tosstime", iTime + 50);
}
